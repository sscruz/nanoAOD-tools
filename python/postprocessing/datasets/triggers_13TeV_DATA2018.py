...
triggers2018=dict(
    ...
    triggers_mumu_noniso = [ "HLT_Mu37_TkMu27" ],
    triggers_mumu_ss = [ "HLT_Mu18_Mu9_SameSign",
                         "HLT_Mu18_Mu9_SameSign_DZ", 
                         "HLT_Mu20_Mu10_SameSign", 
                         "HLT_Mu20_Mu10_SameSign_DZ" ],
    triggers_mumu = [ "HLT_Mu17_TrkIsoVVL_Mu8_TrkIsoVVL_DZ_Mass3p8",
                             "HLT_Mu17_TrkIsoVVL_Mu8_TrkIsoVVL_DZ_Mass8",
                             "HLT_Mu19_TrkIsoVVL_Mu9_TrkIsoVVL_DZ_Mass3p8", 
                             "HLT_Mu19_TrkIsoVVL_Mu9_TrkIsoVVL_DZ_Mass8",
                             "HLT_Mu17_TrkIsoVVL_Mu8_TrkIsoVVL_DZ"
    ...
    triggers_ee = [ "HLT_Ele23_Ele12_CaloIdL_TrackIdL_IsoVL_DZ", 
    ...
    triggers_1mu_iso = [ 'HLT_IsoMu24'],                          # Always unprescaled
    triggers_1mu_noniso = [ 'HLT_Mu50', 'HLT_Mu55', "HLT_TkMu100" ], # 55 only in late part of the data
    triggers_1e_iso = [ "HLT_Ele32_WPTight_Gsf"],
