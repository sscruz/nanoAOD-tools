...
class btagSFProducer(Module):
    ...
    """
    def __init__(self, era, algo = 'csvv2', sfFileName = None, verbose = 0, suffix=""):
        ...
        supported_btagSF = {
            'deepcsv' : {
                '2016' : {
                    'inputFileName' : "DeepCSV_2016LegacySF_WP_V1.csv",
                    'measurement_types' : {
                        0 : "comb",  # b
                        1 : "comb",  # c
                        2 : "incl"   # light
                ...
                '2017' : {
                    'inputFileName' : "DeepCSV_94XSF_WP_V4_B_F.csv",
                    'measurement_types' : {
                        0 : "comb",  # b
                        1 : "comb",  # c
                        2 : "incl"   # light
                ...
                '2018' : {
                    'inputFileName' : "DeepCSV_102XSF_WP_V1.csv",
                    'measurement_types' : {
                        0 : "comb",  # b
                        1 : "comb",  # c
                        2 : "incl"   # light
        ...
        for central_or_syst in self.central_and_systs:
            if central_or_syst == "central":
                self.branchNames_central_and_systs[central_or_syst] = "JetSel_Edge_btagSF%s"%self.suffix
            else:
                self.branchNames_central_and_systs[central_or_syst] = "JetSel_Edge_btagSF%s_%s" % (self.suffix,central_or_syst)

        self.branchNames_central_and_systs_shape_corr = {}
        for central_or_syst in self.central_and_systs_shape_corr:
            if central_or_syst == "central":
                self.branchNames_central_and_systs_shape_corr[central_or_syst] = "JetSel_Edge_btagSF_shape"
            else:
                self.branchNames_central_and_systs_shape_corr[central_or_syst] = "JetSel_Edge_btagSF_shape_%s" % central_or_syst
    ...
    def beginJob(self):
        ...
        for wp in self.supported_wp:
            ...
            for flavor_btv in [0] if 'fast' in self.era else [ 0, 1, 2 ]:
                if wp == "shape_corr":
...
#        for central_or_syst in self.central_and_systs:
#            self.out.branch(self.branchNames_central_and_systs[central_or_syst], "F", lenVar="nJetSel_Edge")
#        for central_or_syst in self.central_and_systs_shape_corr:
#            self.out.branch(self.branchNames_central_and_systs_shape_corr[central_or_syst], "F", lenVar="nJetSel_Edge")
    ...
    def analyze(self, event):
        ...
        jets = Collection(event, "JetSel_Edge")
